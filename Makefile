...
build-colab: ## Regenerate colab/Lab22_DPO_*.ipynb from notebooks/*.py (stdlib only)
...
.PHONY: help setup smoke sft data dpo eval deploy bench pipeline pipeline-full beta-sweep build-colab verify lab test clean clean-all

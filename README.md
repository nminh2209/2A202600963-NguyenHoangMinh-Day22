...
**Option 1: Free Colab (zero install)** — see [`COLAB-GUIDE.md`](COLAB-GUIDE.md) for full steps.
...
Click → Runtime → Change runtime type → **T4 GPU** → Run all (sections A–D, then stages 1–4 for core).
...
- **Datasets:** UltraFeedback (Argilla), `bkai-foundation-models/vi-alpaca` (VN SFT)
